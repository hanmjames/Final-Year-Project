...
# plt.title("Actual vs. Pred FedFunds Values (1997) Tested on 2000-2006 [3 Addnl Vars]")
# plt.legend()
# plt.show()
#
# plt.figure(figsize=(10, 6))
...
# plt.title("Actual vs. Pred FedFunds Values (2002) Tested on 2000-2006 [3 Addnl Vars]")
# plt.legend()
# plt.show()
