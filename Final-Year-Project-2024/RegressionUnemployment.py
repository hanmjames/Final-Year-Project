...
X_1997_q1 = merged_data_q1[["Inflation_Rate_1997", "OutputGap_1997", "UNRATE_19970110"]]
...
X_1997_all = merged_data[["Inflation_Rate_1997", "OutputGap_1997", "UNRATE_19970110"]]
...
X_1997_q1_lagged = add_constant(merged_data_q1[["FedFunds_1997_Lag1", "Inflation_Rate_1997", "OutputGap_1997", "UNRATE_19970110"]])
...
X_1997_all_lagged = add_constant(merged_data[["FedFunds_1997_Lag1", "Inflation_Rate_1997", "OutputGap_1997", "UNRATE_19970110"]])
...
X_2002_q1 = merged_data_q1[["Inflation_Rate_2002", "OutputGap_2002", "UNRATE_20020104"]]
...
X_2002_all = merged_data[["Inflation_Rate_2002", "OutputGap_2002", "UNRATE_20020104"]]
...
X_2002_q1_lagged = add_constant(merged_data_q1[["FedFunds_2002_Lag1", "Inflation_Rate_2002", "OutputGap_2002", "UNRATE_20020104"]])
...
X_2002_all_lagged = add_constant(merged_data[["FedFunds_2002_Lag1", "Inflation_Rate_2002", "OutputGap_2002", "UNRATE_20020104"]])
...
endog_1997_q1 = merged_data_q1[["Inflation_Rate_1997", "OutputGap_1997", "UNRATE_19970110"]]
...
endog_1997_all = merged_data[["Inflation_Rate_1997", "OutputGap_1997", "UNRATE_19970110"]]
...
endog_1997_q1_lagged = merged_data_q1[["Inflation_Rate_1997", "OutputGap_1997", "UNRATE_19970110"]]
...
endog_1997_all_lagged = merged_data[["Inflation_Rate_1997", "OutputGap_1997", "UNRATE_19970110"]]
...
endog_2002_q1 = merged_data_q1[["Inflation_Rate_2002", "OutputGap_2002", "UNRATE_20020104"]]
...
endog_2002_all = merged_data[["Inflation_Rate_2002", "OutputGap_2002", "UNRATE_20020104"]]
...
endog_2002_q1_lagged = merged_data_q1[["Inflation_Rate_2002", "OutputGap_2002", "UNRATE_20020104"]]
...
endog_2002_all_lagged = merged_data[["Inflation_Rate_2002", "OutputGap_2002", "UNRATE_20020104"]]
...
ols_models = [
    ...
    (ols_1997_without_lag_q1,
     train_data_q1[["Inflation_Rate_1997", "OutputGap_1997", "UNRATE_19970110"]],
     train_data_q1["FEDFUNDS_19970107"],
     test_data_q1[["Inflation_Rate_1997", "OutputGap_1997", "UNRATE_19970110"]],
    ...
    (ols_1997_without_lag_all,
     train_data[["Inflation_Rate_1997", "OutputGap_1997", "UNRATE_19970110"]],
     train_data["FEDFUNDS_19970107"],
     test_data[["Inflation_Rate_1997", "OutputGap_1997", "UNRATE_19970110"]],
    ...
    (ols_1997_with_lag_q1,
     ...
     train_data_q1["FEDFUNDS_19970107"],
     test_data_q1[["FedFunds_1997_Lag1", "Inflation_Rate_1997", "OutputGap_1997", "UNRATE_19970110"]],
     test_data_q1["FEDFUNDS_19970107"],
     "OLS 1997 With Lagged FEDFUNDS (Q1)"),

    # OLS 1997 With Lagged FEDFUNDS (All Quarters)
    (ols_1997_with_lag_all,
     train_data[["FedFunds_1997_Lag1", "Inflation_Rate_1997", "OutputGap_1997", "UNRATE_19970110"]],
     train_data["FEDFUNDS_19970107"],
     test_data[["FedFunds_1997_Lag1", "Inflation_Rate_1997", "OutputGap_1997", "UNRATE_19970110"]],
     test_data["FEDFUNDS_19970107"],
     "OLS 1997 With Lagged FEDFUNDS (All Quarters)"),

    # OLS 2002 Without Lagged FEDFUNDS (First Quarter Only)
    (ols_2002_without_lag_q1,
     train_data_q1[["Inflation_Rate_2002", "OutputGap_2002", "UNRATE_20020104"]],
     train_data_q1["FEDFUNDS_20020108"],
     test_data_q1[["Inflation_Rate_2002", "OutputGap_2002", "UNRATE_20020104"]],
    ...
    (ols_2002_without_lag_all,
     train_data[["Inflation_Rate_2002", "OutputGap_2002", "UNRATE_20020104"]],
     train_data["FEDFUNDS_20020108"],
     test_data[["Inflation_Rate_2002", "OutputGap_2002", "UNRATE_20020104"]],
    ...
    (ols_2002_with_lag_q1,
     ...
     train_data_q1["FEDFUNDS_20020108"],
     test_data_q1[["FedFunds_2002_Lag1", "Inflation_Rate_2002", "OutputGap_2002", "UNRATE_20020104"]],
     test_data_q1["FEDFUNDS_20020108"],
     "OLS 2002 With Lagged FEDFUNDS (Q1)"),

    # OLS 2002 With Lagged FEDFUNDS (All Quarters)
    (ols_2002_with_lag_all,
     train_data[["FedFunds_2002_Lag1", "Inflation_Rate_2002", "OutputGap_2002", "UNRATE_20020104"]],
     train_data["FEDFUNDS_20020108"],
     test_data[["FedFunds_2002_Lag1", "Inflation_Rate_2002", "OutputGap_2002", "UNRATE_20020104"]],
     test_data["FEDFUNDS_20020108"],
     "OLS 2002 With Lagged FEDFUNDS (All Quarters)")
]
