...
from Model_Training.RegressionAddnlVars import ols_1997WithoutLagAll, ols_1997WithoutLagQ1, ols_1997WithLagAll, ols_1997WithLagQ1, ols_2002WithLagAll, ols_2002WithLagQ1, ols_2002WithoutLagQ1, ols_2002WithoutLagAll, results1997WithoutLaggedAll, results1997WithLaggedAll, results2002WithLaggedAll, results1997WithLaggedQ1, results2002WithoutLaggedAll, results2002WithLaggedQ1, results2002WithoutLaggedQ1, results1997WithoutLaggedQ1
...
fedFundsTest = fedFundsTest[fedFundsTest['observation_date'] >= "1997-01-01"]
inflationTest = inflationTest[inflationTest['observation_date'] >= "1997-01-01"]
mergedPotGDP = mergedPotGDP[mergedPotGDP['observation_date'] >= "1997-01-01"]
housingTest = housingTest[housingTest['observation_date'] >= "1997-01-01"]
oilTest = oilTest[oilTest['observation_date'] >= "1997-01-01"]
unemploymentTest = unemploymentTest[unemploymentTest['observation_date'] >= "1997-01-01"]
...
mergedTestData.rename(columns={
    ...
    "Oil_Lag1": "OIL_19970303_Lag1",
    "Oil_Lag2": "OIL_19970303_Lag2",
    "Oil_Lag3": "OIL_19970303_Lag3",
    "UNRATE": "UNRATE_19970110",
    "Unemployment_Lag1": "UNRATE_19970110_Lag1",
    "Unemployment_Lag2": "UNRATE_19970110_Lag2",
    "Unemployment_Lag3": "UNRATE_19970110_Lag3"
}, inplace=True)
...
mergedTestData["OIL_20020102_Lag1"] = mergedTestData["OIL_19970303_Lag1"]
mergedTestData["OIL_20020102_Lag2"] = mergedTestData["OIL_19970303_Lag2"]
mergedTestData["OIL_20020102_Lag3"] = mergedTestData["OIL_19970303_Lag3"]
mergedTestData["UNRATE_20020104"] = mergedTestData["UNRATE_19970110"]
mergedTestData["UNRATE_20020104_Lag1"] = mergedTestData["UNRATE_19970110_Lag1"]
mergedTestData["UNRATE_20020104_Lag2"] = mergedTestData["UNRATE_19970110_Lag2"]
mergedTestData["UNRATE_20020104_Lag3"] = mergedTestData["UNRATE_19970110_Lag3"]
mergedTestData["OILPRICE_19970303"] = mergedTestData["OILPRICE_19970303"]
mergedTestData["UNRATE_19970110"] = mergedTestData["UNRATE_19970110"]

scaler = joblib.load("../Model_Training/3AddnlVarsScaler.joblib")
standardizeCols = joblib.load("../Model_Training/3AddnlVarsScalerColumns.joblib")
mergedTestData = mergedTestData[standardizeCols + ["OILPRICE_19970303", "UNRATE_19970110", "OILPRICE_20020102", "UNRATE_20020104", "observation_date"]]
...
ivModels = [
    ...
    (
        ...
        ["Inflation_Rate_1997_Lag1", "Inflation_Rate_1997_Lag2", "Inflation_Rate_1997_Lag3",
         "OutputGap_1997_Lag1", "OutputGap_1997_Lag2", "OutputGap_1997_Lag3",
         "Houses_1997_Lag1", "Oil_1997_Lag1", "Unemployment_1997_Lag1"]
    ),
    (
    ...
    (
        ...
        ["Inflation_Rate_2002_Lag1", "Inflation_Rate_2002_Lag2", "Inflation_Rate_2002_Lag3",
         "OutputGap_2002_Lag1", "OutputGap_2002_Lag2", "OutputGap_2002_Lag3",
         "Houses_2002_Lag1", "Oil_2002_Lag1", "Unemployment_2002_Lag1"]
    ),
    (
