...
print("Merged Data (After Adding Oil Prices):")
...
# Drop rows with NaNs before standardization
...
X_1997_q1 = merged_data_q1[["Inflation_Rate_1997", "OutputGap_1997", "OILPRICE_19970303"]]
...
X_1997_all = merged_data[["Inflation_Rate_1997", "OutputGap_1997", "OILPRICE_19970303"]]
...
X_1997_q1_lagged = add_constant(merged_data_q1[["FedFunds_1997_Lag1", "Inflation_Rate_1997", "OutputGap_1997", "OILPRICE_19970303"]])
...
X_1997_all_lagged = add_constant(merged_data[["FedFunds_1997_Lag1", "Inflation_Rate_1997", "OutputGap_1997", "OILPRICE_19970303"]])
...
X_2002_q1 = merged_data_q1[["Inflation_Rate_2002", "OutputGap_2002", "OILPRICE_20020102"]]
...
X_2002_all = merged_data[["Inflation_Rate_2002", "OutputGap_2002", "OILPRICE_20020102"]]
...
X_2002_q1_lagged = add_constant(merged_data_q1[["FedFunds_2002_Lag1", "Inflation_Rate_2002", "OutputGap_2002", "OILPRICE_20020102"]])
...
X_2002_all_lagged = add_constant(merged_data[["FedFunds_2002_Lag1", "Inflation_Rate_2002", "OutputGap_2002", "OILPRICE_20020102"]])
...
endog_1997_q1 = merged_data_q1[["Inflation_Rate_1997", "OutputGap_1997", "OILPRICE_19970303"]]
...
endog_1997_all = merged_data[["Inflation_Rate_1997", "OutputGap_1997", "OILPRICE_19970303"]]
...
endog_1997_q1_lagged = merged_data_q1[["Inflation_Rate_1997", "OutputGap_1997", "OILPRICE_19970303"]]
...
endog_1997_all_lagged = merged_data[["Inflation_Rate_1997", "OutputGap_1997", "OILPRICE_19970303"]]
...
endog_2002_q1 = merged_data_q1[["Inflation_Rate_2002", "OutputGap_2002", "OILPRICE_20020102"]]
...
endog_2002_all = merged_data[["Inflation_Rate_2002", "OutputGap_2002", "OILPRICE_20020102"]]
...
endog_2002_q1_lagged = merged_data_q1[["Inflation_Rate_2002", "OutputGap_2002", "OILPRICE_20020102"]]
...
endog_2002_all_lagged = merged_data[["Inflation_Rate_2002", "OutputGap_2002","OILPRICE_20020102"]]
...
save_summary(results_1997_without_lagged_q1.summary, "Adding Just Oil Price: IV Regression for 1997 Without Lagged FedFunds (First Quarter Only)", "iv_1997_without_lag_q1_3vars.png")
save_summary(results_1997_without_lagged_all.summary, "Adding Just Oil Price: IV Regression for 1997 Without Lagged FedFunds (All Quarters)", "iv_1997_without_lag_all_3vars.png")
save_summary(results_1997_with_lagged_q1.summary, "Adding Just Oil Price: IV Regression for 1997 With Lagged FedFunds (First Quarter Only)", "iv_1997_with_lag_q1_3vars.png")
save_summary(results_1997_with_lagged_all.summary, "Adding Just Oil Price: IV Regression for 1997 With Lagged FedFunds (All Quarters)", "iv_1997_with_lag_all_3vars.png")
save_summary(results_2002_without_lagged_q1.summary, "Adding Just Oil Price: IV Regression for 2002 Without Lagged FedFunds (First Quarter Only)", "iv_2002_without_lag_q1_3vars.png")
save_summary(results_2002_without_lagged_all.summary, "Adding Just Oil Price: IV Regression for 2002 Without Lagged FedFunds (All Quarters)", "iv_2002_without_lag_all_3vars.png")
save_summary(results_2002_with_lagged_q1.summary, "Adding Just Oil Price: IV Regression for 2002 With Lagged FedFunds (First Quarter Only)", "iv_2002_with_lag_q1_3vars.png")
save_summary(results_2002_with_lagged_all.summary, "Adding Just Oil Price: IV Regression for 2002 With Lagged FedFunds (All Quarters)", "iv_2002_with_lag_all_3vars.png")
...
save_summary(results_1997_without_lagged_q1.first_stage, "First-Stage Results for 1997 Without Lagged FedFunds (First Quarter Only)", "first_stage_1997_without_lag_q1_justoilprice.png")

save_summary(results_1997_without_lagged_all.first_stage, "First-Stage Results for 1997 Without Lagged FedFunds (All Quarters)", "first_stage_1997_without_lag_all_justoilprice.png")

save_summary(results_1997_with_lagged_q1.first_stage, "First-Stage Results for 1997 With Lagged FedFunds (First Quarter Only)", "first_stage_1997_with_lag_q1_justoilprice.png")

save_summary(results_1997_with_lagged_all.first_stage, "First-Stage Results for 1997 With Lagged FedFunds (All Quarters)", "first_stage_1997_with_lag_all_justoilprice.png")

save_summary(results_2002_without_lagged_q1.first_stage, "First-Stage Results for 2002 Without Lagged FedFunds (First Quarter Only)", "first_stage_2002_without_lag_q1_justoilprice.png")

save_summary(results_2002_without_lagged_all.first_stage, "First-Stage Results for 2002 Without Lagged FedFunds (All Quarters)", "first_stage_2002_without_lag_all_justoilprice.png")

save_summary(results_2002_with_lagged_q1.first_stage, "First-Stage Results for 2002 With Lagged FedFunds (First Quarter Only)", "first_stage_2002_with_lag_q1_justoilprice.png")

save_summary(results_2002_with_lagged_all.first_stage, "First-Stage Results for 2002 With Lagged FedFunds (All Quarters)", "first_stage_2002_with_lag_all_justoilprice.png")
...
ols_models = [
    ...
    (ols_1997_with_lag_q1,
     train_data_q1[["FedFunds_1997_Lag1", "Inflation_Rate_1997", "OutputGap_1997", "OILPRICE_19970303"]],
     train_data_q1["FEDFUNDS_19970107"],
     test_data_q1[["FedFunds_1997_Lag1", "Inflation_Rate_1997", "OutputGap_1997", "OILPRICE_19970303"]],
     test_data_q1["FEDFUNDS_19970107"],
     "OLS 1997 With Lagged FEDFUNDS (Q1)"),

    # OLS 1997 With Lagged FEDFUNDS (All Quarters)
    (ols_1997_with_lag_all,
     train_data[["FedFunds_1997_Lag1", "Inflation_Rate_1997", "OutputGap_1997", "OILPRICE_19970303"]],
     train_data["FEDFUNDS_19970107"],
     test_data[["FedFunds_1997_Lag1", "Inflation_Rate_1997", "OutputGap_1997", "OILPRICE_19970303"]],
     test_data["FEDFUNDS_19970107"],
     "OLS 1997 With Lagged FEDFUNDS (All Quarters)"),
    ...
    (ols_2002_with_lag_q1,
     train_data_q1[["FedFunds_2002_Lag1", "Inflation_Rate_2002", "OutputGap_2002", "OILPRICE_20020102"]],
     train_data_q1["FEDFUNDS_20020108"],
     test_data_q1[["FedFunds_2002_Lag1", "Inflation_Rate_2002", "OutputGap_2002", "OILPRICE_20020102"]],
     test_data_q1["FEDFUNDS_20020108"],
     "OLS 2002 With Lagged FEDFUNDS (Q1)"),

    # OLS 2002 With Lagged FEDFUNDS (All Quarters)
    (ols_2002_with_lag_all,
     train_data[["FedFunds_2002_Lag1", "Inflation_Rate_2002", "OutputGap_2002", "OILPRICE_20020102"]],
     train_data["FEDFUNDS_20020108"],
     test_data[["FedFunds_2002_Lag1", "Inflation_Rate_2002", "OutputGap_2002", "OILPRICE_20020102"]],
     test_data["FEDFUNDS_20020108"],
     "OLS 2002 With Lagged FEDFUNDS (All Quarters)")
]
