...
modelComparisons, predictions = evaluateModels(mergedTestData, olsModels, ivModels)
predictionsAllQ = {k: v for k, v in predictions.items() if "All Quarters" in k}
print(modelComparisons)

modelName = "OLS 1997 With Lagged FEDFUNDS (All Quarters)"
...
plt.title("Residuals Over Time – OLS 1997 With Lagged FEDFUNDS (All Quarters)")
plt.xlabel("Date")
