...
joblib.dump(scaler, 'HousesScaler.joblib')
joblib.dump(standardizeCols, 'HousesScalerColumns.joblib')
...
X_1997Q1 = mergedDataQ1[["Inflation_Rate_1997", "OutputGap_1997", "HOUST_19970122"]]
...
X_1997All = mergedData[["Inflation_Rate_1997", "OutputGap_1997", "HOUST_19970122"]]
...
X_1997Q1Lagged = add_constant(mergedDataQ1[["FedFunds_1997_Lag1", "Inflation_Rate_1997", "OutputGap_1997", "HOUST_19970122"]])
...
X_1997AllLagged = add_constant(mergedData[["FedFunds_1997_Lag1", "Inflation_Rate_1997", "OutputGap_1997", "HOUST_19970122"]])
...
X_2002Q1 = mergedDataQ1[["Inflation_Rate_2002", "OutputGap_2002", "HOUST_20020117"]]
...
X_2002All = mergedData[["Inflation_Rate_2002", "OutputGap_2002", "HOUST_20020117"]]
...
X_2002Q1Lagged = add_constant(mergedDataQ1[["FedFunds_2002_Lag1", "Inflation_Rate_2002", "OutputGap_2002", "HOUST_20020117"]])
...
X_2002AllLagged = add_constant(mergedData[["FedFunds_2002_Lag1", "Inflation_Rate_2002", "OutputGap_2002", "HOUST_20020117"]])
...
endog_1997Q1 = mergedDataQ1[["Inflation_Rate_1997", "OutputGap_1997", "HOUST_19970122"]]
...
endog_1997All = mergedData[["Inflation_Rate_1997", "OutputGap_1997", "HOUST_19970122"]]
...
endog_1997Q1Lagged = mergedDataQ1[["Inflation_Rate_1997", "OutputGap_1997", "HOUST_19970122"]]
...
endog_1997AllLagged = mergedData[["Inflation_Rate_1997", "OutputGap_1997", "HOUST_19970122"]]
...
endog_2002Q1 = mergedDataQ1[["Inflation_Rate_2002", "OutputGap_2002", "HOUST_20020117"]]
...
endog_2002All = mergedData[["Inflation_Rate_2002", "OutputGap_2002", "HOUST_20020117"]]
...
endog_2002Q1Lagged = mergedDataQ1[["Inflation_Rate_2002", "OutputGap_2002", "HOUST_20020117"]]
...
endog_2002AllLagged = mergedData[["Inflation_Rate_2002", "OutputGap_2002", "HOUST_20020117"]]
...
def calculateMetricsIV(model, X_TrainExog, X_train_endog, y_train, X_TestExog, X_test_endog, y_test, model_name):
...
olsModels = [
    (ols_1997WithoutLagQ1,
     trainDataQ1[["Inflation_Rate_1997", "OutputGap_1997", "HOUST_19970122"]],
     trainDataQ1["FEDFUNDS_19970107"],
     testDataQ1[["Inflation_Rate_1997", "OutputGap_1997", "HOUST_19970122"]],
    ...
    (ols_1997WithLagQ1,
     trainDataQ1[["FedFunds_1997_Lag1", "Inflation_Rate_1997", "OutputGap_1997", "HOUST_19970122"]],
     trainDataQ1["FEDFUNDS_19970107"],
     testDataQ1[["FedFunds_1997_Lag1", "Inflation_Rate_1997", "OutputGap_1997", "HOUST_19970122"]],
     testDataQ1["FEDFUNDS_19970107"],
    ...
    (ols_2002WithoutLagQ1,
     trainDataQ1[["Inflation_Rate_2002", "OutputGap_2002", "HOUST_20020117"]],
     trainDataQ1["FEDFUNDS_20020108"],
     testDataQ1[["Inflation_Rate_2002", "OutputGap_2002", "HOUST_20020117"]],
    ...
    (ols_2002WithLagQ1,
     trainDataQ1[["FedFunds_2002_Lag1", "Inflation_Rate_2002", "OutputGap_2002", "HOUST_20020117"]],
     trainDataQ1["FEDFUNDS_20020108"],
     testDataQ1[["FedFunds_2002_Lag1", "Inflation_Rate_2002", "OutputGap_2002", "HOUST_20020117"]],
     testDataQ1["FEDFUNDS_20020108"],
...
for model, X_TrainExog, X_train_endog, y_train, X_TestExog, X_test_endog, y_test, model_name in ivModels:
    allMetrics.append(calculateMetricsIV(model, X_TrainExog, X_train_endog, y_train, X_TestExog, X_test_endog, y_test, model_name))
