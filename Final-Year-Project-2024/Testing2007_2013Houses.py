...
plt.title("Actual vs. Pred FedFunds Values (1997) Tested on 2007-2013 [Only Houses]")
plt.legend()
plt.show()
...
plt.title("Actual vs. Pred FedFunds Values (2002) Tested on 2007-2013 [Only Houses]")
plt.legend()
plt.show()
